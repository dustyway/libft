...
LIBFT_ADD_CFILENAMES =  atohex.c count_words.c error_exit.c lst_nth.c \
	lst_del_node.c safe_malloc.c safe_malloc2.c safe_write.c strip_nl.c
...
QU_CFILENAMES = dequeue.c enqueue.c queue_clear.c queue_init.c queue_is_empty.c \
		queue_peek.c queue_peek_n.c queue_size.c

ST_CFILENAMES = stack_clear.c stack_init.c stack_is_empty.c stack_peek.c \
		stack_pop.c stack_push.c stack_size.c
